...
var has3d = function() {
    ...
    for (var e in d) d.hasOwnProperty(e) && void 0 !== c.style[e] && (c.style[e] = "translate3d(1px,1px,1px)", b = window.getComputedStyle(c).getPropertyValue(d[e]));
    document.body.removeChild(c);
    return void 0 !== b && 0 < b.length && "none" !== b
}();
$(document).ready(function() {
    has3d && $("html").addClass("csstransforms3d");
    var c = $("input[name='truyen']").val(),
        b = $("#id_post").val(),
        d = $("#id_post").val();
    if (b) {
        var e = localStorage.getItem("fluid-switch"),
            k = localStorage.getItem("onebreak-switch"),
            f = localStorage.getItem("bgcolor"),
            l = localStorage.getItem("font"),
            m = localStorage.getItem("size"),
            h = localStorage.getItem("lineheight"),
           cl = localStorage.getItem("color"),
            p = localStorage.getItem("hidenav"),
            q = $("#chapter-num").val();
        original_content = $(".chapter-content").html();
        f && "#F4F4F4" != f && ("hatsan" == f ? $("body").css({
            "background-color": "#f2f2f2",
            "background-image": "url('"+siteurl+"/wp-content/themes/boxtruyen/images/bg_op.png')"
        }) : $("body").css({
            "background-color": f,
            "background-image": "none"
        }), $("#truyen-background").val(f));
       cl ? ($(".chapter-content").css("color", cl), $(".chapter-title").css("color", cl), $("#mau-chu").val(cl)) : $("#mau-chu").val("#3B3B3B");
        l ? ($(".chapter-content").css("font-family", l), $("#font-chu").val(l)) : $.browser.mobile && $("#font-chu").val("Arial, sans-serif");
        m ? ($("#size-chu").val(m), $(".chapter-content").css("font-size", m)) : $.browser.mobile || $("#size-chu").val("22px");
        h && "180%" != h ? ($("#line-height").val(h), $(".chapter-content").css("line-height", h)) : $("#line-height").val("180%");
        1 == p && ($(".navbar").hide(), $(".chapter .toggle-nav-open").html('<span class="glyphicon glyphicon-menu-down"></span>'), $(".chapter").css("margin-top", "10px"));
        1 == e && ($(".chapter").removeClass("container").addClass("container-fluid"), $("#fluid-no").attr("checked", !1), $("#fluid-yes").attr("checked", !0));
        1 == k && ($(".chapter-content").html($(".chapter-content").html().replace(/(<br\s*\/?>\s*\n?(&nbsp;)?){2,}/gi, "<br>")), $("#onebreak-no").attr("checked", !1), $("#onebreak-yes").attr("checked", !0));
        ...
        $("#font-chu").on("change", function() {
            isPrivacy();
            var a = this.value;
            $(".chapter-content").css("font-family", a);
            localStorage.setItem("font", a)
        });
        $("#size-chu").on("change", function() {
            isPrivacy();
            var a = this.value;
            $(".chapter-content").css("font-size", a);
            localStorage.setItem("size", a)
        });
        $("#line-height").on("change", function() {
            isPrivacy();
            var a = this.value;
            $(".chapter-content").css("line-height", a);
            localStorage.setItem("lineheight", a)
        });
        $("#mau-chu").on("change", function() {
            isPrivacy();
            var a = this.value;
            $(".chapter-content").css("color", a);
            $(".chapter-title").css("color", a);
            localStorage.setItem("color", a)
        });
        $(document.body).on("click", ".chapter .toggle-nav-open", function() {
            1 == localStorage.getItem("hidenav") ? ($(".navbar").slideDown(300), $(this).html('<span class="glyphicon glyphicon-menu-up"></span>'), $(".chapter").css("margin-top", "0"), localStorage.removeItem("hidenav")) : ($(".navbar").slideUp(300), $(this).html('<span class="glyphicon glyphicon-menu-down"></span>'), $(".chapter").css("margin-top", "10px"), localStorage.setItem("hidenav", 1))
        });
        ...
        $('input[name="fluid-switch"]').click(function() {
            "yes" == this.value ? ($(".chapter").removeClass("container").addClass("container-fluid"), localStorage.setItem("fluid-switch", 1)) : ($(".chapter").removeClass("container-fluid").addClass("container"), localStorage.removeItem("fluid-switch"))
        });
        $('input[name="onebreak-switch"]').click(function() {
            "yes" == this.value ? ($(".chapter-content").html($(".chapter-content").html().replace(/(<br\s*\/?>\s*\n?(&nbsp;)?){2,}/gi, "<br>")), localStorage.setItem("onebreak-switch", 1)) : ($(".chapter-content").html(original_content), localStorage.removeItem("onebreak-switch"))
        });
        $(".chapter-nav").on("click", "button#chapter_jump", function() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {'action' : 'tw_ajax', 'type':'list_chap', 'chap' : chap, 'id' : d},
                success: function(a) {
    ...
    $("#contact-form").submit(function(a) {
        a.preventDefault();
        a = $("#contact-name").val();
        var c = $("#contact-email").val(),
            b = $("#contact-subject").val(),
            d = $("#contact-message").val(),
            e = $("#contact-secure").val();
        a && b && d || $("#contact-status").removeClass("alert-success hide").addClass("alert-danger").text("B\u1ea1n vui l\u00f2ng \u0111i\u1ec1n \u0111\u1ee7 th\u00f4ng tin li\u00ean h\u1ec7.");
        $("#contact-form :input").attr("disabled", !0);
        ...
        $.post("/ajax.php", {
            ...
            $("#contact-form :input").attr("disabled", !1);
            $("#contact-btn").attr("disabled", !1);
            "success" == a.status ? ($("#contact-status").removeClass("alert-danger hide").addClass("alert-success").text("B\u1ea1n \u0111\u00e3 g\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u00e0nh c\u00f4ng!"), $("#contact-form").trigger("reset"), $("#contact-secure").val(a.token)) : (console.log(a), $("#contact-status").removeClass("alert-success hide").addClass("alert-danger").text("G\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u1ea5t b\u1ea1i, b\u1ea1n vui l\u00f2ng th\u1eed l\u1ea1i sau."))
        })
    });
...
(function($){
    ...
    $(".rate-holder").raty({
        number: 10,
        path: site + "/wp-content/themes/boxtruyen/images/",
